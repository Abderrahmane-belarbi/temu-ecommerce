        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-center text-red-500 text-sm md:text-base font-semibold animate-pulse">
              Only {15} items left at this price
            </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 bg-red-50 p-2 rounded-lg">
              ...
              <span className="text-red-600 font-medium text-sm">
                You Save {formatPrice(product.price * 0.2).replace("$", "")}!
              </span>
            </div>

            <div className="flex items-center gap-2 text-xs text-gray-600">
              <span className="inline-block w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
              <span className="">1.4k people bought in the last hour</span>
            </div>
            ...
            <div className="flex flex-col gap-3 mt-6 text-sm bg-white p-4 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="flex items-center gap-3 text-gray-700">
                <span className="bg-green-100 p-2 rounded-full"><RiRecycleFill className="text-green-700" size={20}/></span>
                <span className="font-medium">30-day money-back Guarantee</span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                <span className="bg-green-100 p-2 rounded-full"><IoShieldCheckmarkOutline className="text-green-800" size={20}/></span>
